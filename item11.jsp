    ...
    <body class="container-fluid" style="height:100%;" width="100%;">
        ...
        <div class="row " style="margin-top:4%;">
            <div class="col-md-5 col-sm-6 col">
                <img class="img-flex" src="Productimg/pimg15.jpg" width="80%" height="80%">
            ...
            <div class="col-md-5 col-sm-6 col">
                ...
                <div class="row"
                    ...
                    <b style="font-size:x-large;"> US$432.00/ </b><span style="padding:1.5% ;">Piece|1 Piece/Pieces(Min.
                        Order)</span>
                </div>
                <div class="row my-4">
                    <div class="col-md-3"> Color:</div>
                    <div class="col-md-8"><img src="Productimg/pimg15.jpg" width="30px" height="30px"></div>
                </div>
                <div class="row my-3">
                ...
                <div class="row my-3">
                    ...
                    <button type="button"onclick="window.location.href = 'BuyProduct.jsp?p_id=item11';" style="border-radius: 25px; border: none; width:30% ;  height:17%; color: gray;  padding-bottom:0.5%;  font-family: serif;"  class="bg-primary text-dark my-4">Buy Now</button>
