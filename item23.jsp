    ...
    <body class="container-fluid" style="height:100%;" width="100%;">
        ...
        <div class="row " style="margin-top:4%;">
            <div class="col-md-5 col-sm-6 col">
                <img class="img-flex" src="Productimg/pimg41.jpg" width="80%" height="80%">
                <h4 style="color: rgb(146,146,146); text-align: center;padding-right: 13%; font-family: serif; padding-top: 5%; ">Large imege</h4>

            </div>
            <div class="col-md-5 col-sm-6 col">
                <p style="font-size: large;">Notebook 13 Display M1 Chip With 8-Core Processor and 7-Core Graphics 8GB Unified Memory English Keyboard Laptop</p>
                ...
                <div class="row"
                    ...
                    <b style="font-size:x-large;">$914.00/ </b><span style="padding:1.5% ;">>=1 Piece/Pieces(Min.
                        Order)</span>
                </div>
                <div class="row my-4">
                    <div class="col-md-3"> Color:</div>
                    <div class="col-md-8"><img src="Productimg/pimg41.jpg" width="30px" height="30px"></div>
                </div>
                <div class="row my-3">
                ...
                <div class="row my-3">
                    ...
                    <div class="col-md-8">f23hF568UJ</div>
                </div>
                ...
                <div class="row my-3">
                    ...
                    <button type="button"onclick="window.location.href = 'BuyProduct.jsp?p_id=item23';"style="border-radius: 25px; border: none; width:30% ;  height:17%; color: gray;  padding-bottom:0.5%;  font-family: serif;"  class="bg-primary text-dark my-4">Buy Now</button>
