    ...
    <body class="container-fluid" style="height:100%;" width="100%;">
        ...
        <div class="row " style="margin-top:4%;">
            <div class="col-md-5 col-sm-6 col">
                <img class="img-flex" src="Productimg/pimg33.jpg" width="80%" height="80%">
                <h4 style="color: rgb(146,146,146); text-align: center;padding-right: 13%; font-family: serif; padding-top: 5%; ">Large imege</h4>

            </div>
            <div class="col-md-5 col-sm-6 col">
                <p style="font-size: large;">Smartphone Phone 13 With FaceTime 6.1-inch High-Definition Face Recognitio Good price long standby time mobile phone smart phone</p>
                ...
                <div class="row"
                    ...
                    <b style="font-size:x-large;"> $830.00 - $1,062.00/ </b><span style="padding:1.5% ;">Piece|1 Piece/Pieces(Min.
                        Order)</span>
                </div>
                <div class="row my-4">
                    <div class="col-md-3"> Color:</div>
                    <div class="col-md-8"><img src="Productimg/pimg33.jpg" width="30px" height="30px"></div>
                </div>
                <div class="row my-3">
                    <div class="col-md-3">Storage capacity: </div>
                ...
                <div class="row my-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2" style="border: 1px solid  rgb(146,146,146);font-size: 90%;width:40%;">5</div>
                            <div class="col-md-5 col-sm-4" style="border: 1px solid  rgb(146,146,146);font-size: 90%;width:40%;">To be negotiated</div>
                        </div>
                    </div>
                    <button type="button"onclick="window.location.href = 'BuyProduct.jsp?p_id=item30';" style="border-radius: 25px; border: none; width:30% ;  height:17%; color: gray;  padding-bottom:0.5%;  font-family: serif;"  class="bg-primary text-dark my-4">Buy Now</button>
